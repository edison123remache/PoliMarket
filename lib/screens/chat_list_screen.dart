                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.separated(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        final ultimoMensaje = (chat['ultimo_mensaje'] ?? '')
                            .toString();
                        final ultimoMensajeEn =
                            chat['ultimo_mensaje_en'] as String?;
                        final servicioTitulo =
                            chat['servicio_titulo']?.toString() ?? '';
                        final servicioFotoUrl = chat['servicio_foto_url']
                            ?.toString();
                          ...
                          builder: (context, profileSnap) {
                            ...
                            return ListTile(
                              ...
                              subtitle: ultimoMensaje.isNotEmpty
                                  ...
                                  : null,
                              trailing: Text(
                                _formatLastMessageTime(ultimoMensajeEn),
                              ),
                              onTap: () async {
